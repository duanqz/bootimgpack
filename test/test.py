...
class TestUnpack(unittest.TestCase):
    ...
    def test_unpack_common(self):
        boot_img = os.path.join(self.dir, "common-boot.img")
        Utils.assert_type_equals(boot_img, "QCOM")

    def test_unpack_common_v1(self):
        boot_img = os.path.join(self.dir, "common-v1-boot.img")
        Utils.assert_type_equals(boot_img, "QCOM")

    def test_unpack_qcom(self):
        boot_img = os.path.join(self.dir, "qcom-boot.img")
        Utils.assert_type_equals(boot_img, "QCOM")

    def test_unpack_mtk(self):
        boot_img = os.path.join(self.dir, "mtk-boot.img")
        Utils.assert_type_equals(boot_img, "MTK")

    def test_unpack_sony(self):
        boot_img = os.path.join(self.dir, "sony-boot.img")
...
class TestPack(unittest.TestCase):
    ...
    def test_pack_common(self):
        boot_dir = os.path.join(self.dir, "common-boot")
        Utils.asset_pack_succ(boot_dir)

    def test_pack_common_v1(self):
        boot_dir = os.path.join(self.dir, "common-v1-boot")
        Utils.asset_pack_succ(boot_dir)

    def test_pack_mtk(self):
        boot_dir = os.path.join(self.dir, "mtk-boot")
        Utils.asset_pack_succ(boot_dir)

    def test_pack_qcom(self):
        boot_dir = os.path.join(self.dir, "qcom-boot")
        Utils.asset_pack_succ(boot_dir)

    def test_pack_sony(self):
        boot_dir = os.path.join(self.dir, "sony-boot")
        Utils.asset_pack_succ(boot_dir)
...
class TestToolKit(unittest.TestCase):
    ...
    def test_existing(self):
        assert os.path.exists(bootimg.Toolkit.TOOLKIT_XML)
    ...
    def test_content_valid(self):
        ...
        for tool in tree.findall("tool"):
            ...
            all_tools[boot_type] =  { "UNPACK" : os.path.join(bootimg.Toolkit.TOOLS_ROOT, unpack_tool),
                                      "PACK"   : os.path.join(bootimg.Toolkit.TOOLS_ROOT, pack_tool) }
